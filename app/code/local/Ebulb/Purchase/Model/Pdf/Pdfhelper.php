 ...
 */
abstract class Ebulb_Purchase_Model_Pdf_Pdfhelper extends Mage_Sales_Model_Order_Pdf_Abstract
{
	 ...
	 */
	 public function widthForStringUsingFontSize($string, $font, $fontSize)
	 {
	 	...
	 	{
	 		die("Erreur dans Ebulb pdf helper méthode widthForStringUsingFontSize avec string = ".$string);
	 	}
	 }
	  ...
	  * @param unknown_type $page
	  */
	 public function drawFooter(&$page,$order)
	 {
        ...
        $this->DrawMultilineText($page, Mage::getStoreConfig('purchase/general/footer_text',$order->getStoreId()), 20,  $this->_BLOC_FOOTER_HAUTEUR, 10, 0, 15);
	 ...
	 public function AddAddressesBlock(&$page, $LeftAddress, $RightAddress, $TxtDate, $TxtInfo)
	 {
        ...
        $this->y -= 20;
        $this->DrawMultilineText($page, "To:\n".$LeftAddress, 25, $this->y, 10, 0.4, 11);
        
		$this->DrawMultilineText($page, "Ship to:\n".$RightAddress, $this->_PAGE_WIDTH / 2 + 10, $this->y, 10, 0.4, 11);
