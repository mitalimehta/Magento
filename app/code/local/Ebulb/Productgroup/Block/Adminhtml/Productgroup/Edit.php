...
class Ebulb_Productgroup_Block_Adminhtml_Productgroup_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('productgroup')->__('Save Product Group'));
