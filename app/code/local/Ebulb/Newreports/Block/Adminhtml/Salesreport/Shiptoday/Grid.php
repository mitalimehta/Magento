 ...
 */
class Ebulb_Newreports_Block_Adminhtml_Salesreport_Shiptoday_Grid extends Mage_Adminhtml_Block_Report_Grid_Abstract 
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addExportType('*/*/exportshiptodayCsv', Mage::helper('reports')->__('CSV'));
        $this->addExportType('*/*/exportshiptodayExcel', Mage::helper('reports')->__('Excel'));
