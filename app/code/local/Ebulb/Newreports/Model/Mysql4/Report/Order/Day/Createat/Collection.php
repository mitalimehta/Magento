 ...
 */
class Ebulb_Newreports_Model_Mysql4_Report_Order_Day_Createat_Collection extends Mage_Sales_Model_Mysql4_Report_Collection_Abstract
{
        ...
        *******/
        ...
        $select = $this->getSelect() 
           ...
           // ->joinLeft(array('si'=>'sales_shipping_info'),'e.increment_id = si.order_id',array())  
            ...
            //->columns(" e.shipping_description as shipping_description") 
