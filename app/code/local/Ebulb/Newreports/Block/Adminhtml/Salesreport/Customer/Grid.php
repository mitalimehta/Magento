 ...
 */
class Ebulb_Newreports_Block_Adminhtml_Salesreport_Customer_Grid extends Mage_Adminhtml_Block_Report_Grid_Abstract 
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('customer_id', array(
            'header'           => Mage::helper('newreports')->__('customer id'),
            'index'            => 'customer_id', 
            'width'            => 100, 
            'totals_label'     => '',
            'sortable'         => true
        ...
        */
        ...
        $this->addExportType('*/*/exportsalepercustomerCsv', Mage::helper('reports')->__('CSV'));
        $this->addExportType('*/*/exportsalepercustomerExcel', Mage::helper('reports')->__('Excel'));
