 ...
 */
class Ebulb_Newreports_Block_Adminhtml_Salesreport_Salesperson_Grid extends Mage_Adminhtml_Block_Report_Grid_Abstract 
{
    ...
    {  
        ...
        */
        ...
        $this->addExportType('*/*/exportsalepersalespersonCsv', Mage::helper('reports')->__('CSV'));
        $this->addExportType('*/*/exportsalepersalespersonExcel', Mage::helper('reports')->__('Excel'));
