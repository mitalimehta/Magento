...
class Ebulb_Newreports_Block_Adminhtml_Salesreport_Tax_Filter_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Report type options
     */
    ...
    protected function _prepareForm()
    {
       ...
       /* $fieldset->addField('order_status', 'checkbox', array(
        ...
        $fieldset->addField('order_tax_report', 'hidden', array(
            'name'      => 'order_tax_report',
            'value'     => 1, 
        )); 
