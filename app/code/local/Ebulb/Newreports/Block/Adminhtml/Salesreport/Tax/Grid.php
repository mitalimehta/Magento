 ...
 */
class Ebulb_Newreports_Block_Adminhtml_Salesreport_Tax_Grid extends Mage_Adminhtml_Block_Report_Grid_Abstract 
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('state', array(
            'header'           => Mage::helper('newreports')->__('State'),
            'index'            => 'state', 
            'width'            => 250, 
            'totals_label'     => '',
            'sortable'         => true
        ...
        $this->addExportType('*/*/exportsalestaxCsv', Mage::helper('reports')->__('CSV'));
        $this->addExportType('*/*/exportsalestaxExcel', Mage::helper('reports')->__('Excel'));
