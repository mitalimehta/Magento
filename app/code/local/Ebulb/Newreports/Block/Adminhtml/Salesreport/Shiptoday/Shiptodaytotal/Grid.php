 ...
 */
class Ebulb_Newreports_Block_Adminhtml_Salesreport_Shiptoday_Shiptodaytotal_Grid extends Mage_Adminhtml_Block_Report_Grid_Abstract 
{
    ...
    {  
        parent::__construct();
        $this->setId('salesshippingtodaytotal'); 
   ...
   public function getResourceCollectionName()
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('shipping_today', array(
            'header'           => Mage::helper('newreports')->__('Ship Today Total'),
            //'renderer'         => 'Ebulb_Newreports_Block_Adminhtml_Renderer_Shiptoday',
        ...
        $this->addExportType('*/*/exportshiptodaytotalCsv', Mage::helper('reports')->__('CSV'));
        $this->addExportType('*/*/exportshiptodaytotalExcel', Mage::helper('reports')->__('Excel'));
