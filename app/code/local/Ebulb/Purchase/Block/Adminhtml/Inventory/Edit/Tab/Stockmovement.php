 ...
 */
class Ebulb_Purchase_Block_Adminhtml_Inventory_Edit_Tab_Stockmovement extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return $this->getUrl('*/*/stockmovement', array('_current' => true));
    }
